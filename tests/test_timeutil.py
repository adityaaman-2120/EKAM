...
def test_to_utc_ns_aware_and_naive() -> None:
    aware = datetime(2023, 10, 11, 22, 14, 15, tzinfo=UTC)
...
def test_rfc3164_recent_date_gets_matching_year() -> None:
    ...
    got = datetime.fromtimestamp(ns / _SEC, UTC)
